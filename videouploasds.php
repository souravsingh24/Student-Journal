    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 upload-container">
                <h2 class="text-center mb-4">Select Video to Upload</h2>
                <form action="video_upload.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="video_name">Choose a VIDEO file:</label><br>
                        <input type="file" name="video_name" id="fileToUpload" accept=".mp4, .avi, .3gp, .mov, .mpeg" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                        <input type="submit" class="btn btn-success btn-upload" name="submit" value="Upload Video">
                    </div>
                </form>
                <!-- Back Button -->
