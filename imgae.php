...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6 upload-container">
            <h2 class="text-center mb-4">Select Image to Upload</h2>
            <form action="imageupload.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="image_name">Choose an IMAGE file:</label><br>
                    <input type="file" name="image_name" id="fileToUpload" accept=".jpg, .jpeg, .png" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center"> 
                    <input type="submit" class="btn btn-success btn-upload" name="submit" value="Upload Image">
                </div>
            </form>
            <!-- Back Button -->
...
<script>
    ...
    // Show/hide the other subject text box based on the selection
